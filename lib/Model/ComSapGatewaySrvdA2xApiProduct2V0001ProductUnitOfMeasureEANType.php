<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductUnitOfMeasureEAN_Type';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['consecutive_number']) && (mb_strlen($this->container['consecutive_number']) > 5)) {
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType., must be smaller than or equal to 18.');
        }
    ...
    public function setAlternativeUnit($alternative_unit)
    {
        ...
        if ((mb_strlen($alternative_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $alternative_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType., must be smaller than or equal to 3.');
        }
     ...
     *
     * @param string|null $consecutive_number Consecutive Number
     *
     * @return self
     */
    public function setConsecutiveNumber($consecutive_number)
    {
        ...
        if ((mb_strlen($consecutive_number) > 5)) {
            throw new \InvalidArgumentException('invalid length for $consecutive_number when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType., must be smaller than or equal to 5.');
        }
    ...
    public function setAlternativeIsoUnit($alternative_iso_unit)
    {
        ...
        if ((mb_strlen($alternative_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $alternative_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType., must be smaller than or equal to 3.');
        }
    ...
    public function setProductStandardId($product_standard_id)
    {
        ...
        if ((mb_strlen($product_standard_id) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product_standard_id when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType., must be smaller than or equal to 18.');
        }
    ...
    public function setInternationalArticleNumberCat($international_article_number_cat)
    {
        ...
        if ((mb_strlen($international_article_number_cat) > 2)) {
            throw new \InvalidArgumentException('invalid length for $international_article_number_cat when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureEANType., must be smaller than or equal to 2.');
        }
