...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductSales_Type-create';
    ...
    */
    ...
    public function setSalesStatus($sales_status)
    {
        ...
        if ((mb_strlen($sales_status) > 2)) {
            throw new \InvalidArgumentException('invalid length for $sales_status when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setTransportationGroup($transportation_group)
    {
        ...
        if ((mb_strlen($transportation_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $transportation_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setPackagingProductType($packaging_product_type)
    {
        ...
        if ((mb_strlen($packaging_product_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $packaging_product_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setAllowedPackagingWeightQtyUnit($allowed_packaging_weight_qty_unit)
    {
        ...
        if ((mb_strlen($allowed_packaging_weight_qty_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $allowed_packaging_weight_qty_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setAllwdPackagingWeightQtyIsoUnit($allwd_packaging_weight_qty_iso_unit)
    {
        ...
        if ((mb_strlen($allwd_packaging_weight_qty_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $allwd_packaging_weight_qty_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setAllowedPackagingVolumeQtyUnit($allowed_packaging_volume_qty_unit)
    {
        ...
        if ((mb_strlen($allowed_packaging_volume_qty_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $allowed_packaging_volume_qty_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setAllwdPackagingVolumeQtyIsoUnit($allwd_packaging_volume_qty_iso_unit)
    {
        ...
        if ((mb_strlen($allwd_packaging_volume_qty_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $allwd_packaging_volume_qty_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesTypeCreate., must be smaller than or equal to 3.');
        }
