<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductChangeMaster_Type';
    ...
    */
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterType., must be smaller than or equal to 18.');
        }
    ...
    public function setChangeNumber($change_number)
    {
        ...
        if ((mb_strlen($change_number) > 12)) {
            throw new \InvalidArgumentException('invalid length for $change_number when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterType., must be smaller than or equal to 12.');
        }
    ...
    public function setRevisionLevel($revision_level)
    {
        ...
        if ((mb_strlen($revision_level) > 2)) {
            throw new \InvalidArgumentException('invalid length for $revision_level when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterType., must be smaller than or equal to 2.');
        }
