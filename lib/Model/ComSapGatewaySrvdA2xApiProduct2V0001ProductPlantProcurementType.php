<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantProcurement_Type';
    ...
    */
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType., must be smaller than or equal to 18.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType., must be smaller than or equal to 4.');
        }
    ...
    public function setJustInTimeDeliveryScheduleCode($just_in_time_delivery_schedule_code)
    {
        ...
        if ((mb_strlen($just_in_time_delivery_schedule_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $just_in_time_delivery_schedule_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType., must be smaller than or equal to 1.');
        }
    ...
    public function setPurchasingGroup($purchasing_group)
    {
        ...
        if ((mb_strlen($purchasing_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType., must be smaller than or equal to 3.');
        }
    ...
    public function setSourceOfSupplyCategory($source_of_supply_category)
    {
        ...
        if ((mb_strlen($source_of_supply_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $source_of_supply_category when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementType., must be smaller than or equal to 1.');
        }
