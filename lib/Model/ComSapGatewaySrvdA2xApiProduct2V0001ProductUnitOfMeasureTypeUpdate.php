<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductUnitOfMeasure_Type-update';
    ...
    */
    ...
    public function setVolumeUnit($volume_unit)
    {
        ...
        if ((mb_strlen($volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $volume_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setVolumeIsoUnit($volume_iso_unit)
    {
        ...
        if ((mb_strlen($volume_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $volume_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setWeightUnit($weight_unit)
    {
        ...
        if ((mb_strlen($weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $weight_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setWeightIsoUnit($weight_iso_unit)
    {
        ...
        if ((mb_strlen($weight_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $weight_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setGlobalTradeItemNumber($global_trade_item_number)
    {
        ...
        if ((mb_strlen($global_trade_item_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $global_trade_item_number when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 18.');
        }
    ...
    public function setGlobalTradeItemNumberCategory($global_trade_item_number_category)
    {
        ...
        if ((mb_strlen($global_trade_item_number_category) > 2)) {
            throw new \InvalidArgumentException('invalid length for $global_trade_item_number_category when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setProductMeasurementUnit($product_measurement_unit)
    {
        ...
        if ((mb_strlen($product_measurement_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $product_measurement_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setProductMeasurementIsoUnit($product_measurement_iso_unit)
    {
        ...
        if ((mb_strlen($product_measurement_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $product_measurement_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setLowerLevelPackagingUnit($lower_level_packaging_unit)
    {
        ...
        if ((mb_strlen($lower_level_packaging_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $lower_level_packaging_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setLowerLevelPackagingIsoUnit($lower_level_packaging_iso_unit)
    {
        ...
        if ((mb_strlen($lower_level_packaging_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $lower_level_packaging_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductUnitOfMeasureTypeUpdate., must be smaller than or equal to 3.');
        }
