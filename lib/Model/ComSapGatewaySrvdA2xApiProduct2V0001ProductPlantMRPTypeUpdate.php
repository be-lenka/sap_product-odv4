...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantMRP_Type-update';
    ...
    */
    ...
    public function setMrpType($mrp_type)
    {
        ...
        if ((mb_strlen($mrp_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $mrp_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setMrpResponsible($mrp_responsible)
    {
        ...
        if ((mb_strlen($mrp_responsible) > 3)) {
            throw new \InvalidArgumentException('invalid length for $mrp_responsible when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setMrpGroup($mrp_group)
    {
        ...
        if ((mb_strlen($mrp_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $mrp_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setPlanAndOrderDayDetermination($plan_and_order_day_determination)
    {
        ...
        if ((mb_strlen($plan_and_order_day_determination) > 3)) {
            throw new \InvalidArgumentException('invalid length for $plan_and_order_day_determination when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPlanningTimeFence($planning_time_fence)
    {
        ...
        if ((mb_strlen($planning_time_fence) > 3)) {
            throw new \InvalidArgumentException('invalid length for $planning_time_fence when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setLotSizingProcedure($lot_sizing_procedure)
    {
        ...
        if ((mb_strlen($lot_sizing_procedure) > 2)) {
            throw new \InvalidArgumentException('invalid length for $lot_sizing_procedure when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setRoundingProfile($rounding_profile)
    {
        ...
        if ((mb_strlen($rounding_profile) > 4)) {
            throw new \InvalidArgumentException('invalid length for $rounding_profile when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setProcurementSubType($procurement_sub_type)
    {
        ...
        if ((mb_strlen($procurement_sub_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $procurement_sub_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setProductionInvtryManagedLoc($production_invtry_managed_loc)
    {
        ...
        if ((mb_strlen($production_invtry_managed_loc) > 4)) {
            throw new \InvalidArgumentException('invalid length for $production_invtry_managed_loc when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setDfltStorageLocationExtProcmt($dflt_storage_location_ext_procmt)
    {
        ...
        if ((mb_strlen($dflt_storage_location_ext_procmt) > 4)) {
            throw new \InvalidArgumentException('invalid length for $dflt_storage_location_ext_procmt when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setMrpPlanningCalendar($mrp_planning_calendar)
    {
        ...
        if ((mb_strlen($mrp_planning_calendar) > 3)) {
            throw new \InvalidArgumentException('invalid length for $mrp_planning_calendar when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRangeOfCvrgPrflCode($range_of_cvrg_prfl_code)
    {
        ...
        if ((mb_strlen($range_of_cvrg_prfl_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $range_of_cvrg_prfl_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setSafetySupplyDurationInDays($safety_supply_duration_in_days)
    {
        ...
        if ((mb_strlen($safety_supply_duration_in_days) > 2)) {
            throw new \InvalidArgumentException('invalid length for $safety_supply_duration_in_days when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setStorageCostsPercentageCode($storage_costs_percentage_code)
    {
        ...
        if ((mb_strlen($storage_costs_percentage_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $storage_costs_percentage_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setSafetyTimePeriodProfile($safety_time_period_profile)
    {
        ...
        if ((mb_strlen($safety_time_period_profile) > 3)) {
            throw new \InvalidArgumentException('invalid length for $safety_time_period_profile when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setDependentRqmtMrpRelevance($dependent_rqmt_mrp_relevance)
    {
        ...
        if ((mb_strlen($dependent_rqmt_mrp_relevance) > 1)) {
            throw new \InvalidArgumentException('invalid length for $dependent_rqmt_mrp_relevance when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductSafetyTimeMrpRelevance($product_safety_time_mrp_relevance)
    {
        ...
        if ((mb_strlen($product_safety_time_mrp_relevance) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_safety_time_mrp_relevance when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setMrpSafetyStockMethod($mrp_safety_stock_method)
    {
        ...
        if ((mb_strlen($mrp_safety_stock_method) > 2)) {
            throw new \InvalidArgumentException('invalid length for $mrp_safety_stock_method when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantMRPTypeUpdate., must be smaller than or equal to 3.');
        }
