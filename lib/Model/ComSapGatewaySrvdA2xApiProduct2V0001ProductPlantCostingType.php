<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantCosting_Type';
    ...
    */
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 18.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 4.');
        }
    ...
    public function setTaskListGroup($task_list_group)
    {
        ...
        if ((mb_strlen($task_list_group) > 8)) {
            throw new \InvalidArgumentException('invalid length for $task_list_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 8.');
        }
    ...
    public function setTaskListType($task_list_type)
    {
        ...
        if ((mb_strlen($task_list_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $task_list_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 1.');
        }
    ...
    public function setCostingSpecialProcurementType($costing_special_procurement_type)
    {
        ...
        if ((mb_strlen($costing_special_procurement_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $costing_special_procurement_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 2.');
        }
    ...
    public function setSourceBomAlternative($source_bom_alternative)
    {
        ...
        if ((mb_strlen($source_bom_alternative) > 2)) {
            throw new \InvalidArgumentException('invalid length for $source_bom_alternative when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 2.');
        }
    ...
    public function setProductBomUsage($product_bom_usage)
    {
        ...
        if ((mb_strlen($product_bom_usage) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_bom_usage when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 1.');
        }
    ...
    public function setTaskListGroupCounter($task_list_group_counter)
    {
        ...
        if ((mb_strlen($task_list_group_counter) > 2)) {
            throw new \InvalidArgumentException('invalid length for $task_list_group_counter when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 2.');
        }
    ...
    public function setVarianceKey($variance_key)
    {
        ...
        if ((mb_strlen($variance_key) > 6)) {
            throw new \InvalidArgumentException('invalid length for $variance_key when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 6.');
        }
    ...
    public function setCostingProductionVersion($costing_production_version)
    {
        ...
        if ((mb_strlen($costing_production_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $costing_production_version when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 4.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantCostingType., must be smaller than or equal to 3.');
        }
