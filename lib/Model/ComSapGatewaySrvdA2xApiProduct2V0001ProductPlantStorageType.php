<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantStorage_Type';
    ...
    */
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType., must be smaller than or equal to 18.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType., must be smaller than or equal to 4.');
        }
    ...
    public function setPhysInventoryForCycleCounting($phys_inventory_for_cycle_counting)
    {
        ...
        if ((mb_strlen($phys_inventory_for_cycle_counting) > 1)) {
            throw new \InvalidArgumentException('invalid length for $phys_inventory_for_cycle_counting when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType., must be smaller than or equal to 1.');
        }
    ...
    public function setProdMaximumStoragePeriodUnit($prod_maximum_storage_period_unit)
    {
        ...
        if ((mb_strlen($prod_maximum_storage_period_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prod_maximum_storage_period_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType., must be smaller than or equal to 3.');
        }
    ...
    public function setMaximumStoragePeriodIsoUnit($maximum_storage_period_iso_unit)
    {
        ...
        if ((mb_strlen($maximum_storage_period_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $maximum_storage_period_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageType., must be smaller than or equal to 3.');
        }
