<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantStorageLocation_Type-update';
    ...
    */
    ...
    public function setWarehouseStorageBin($warehouse_storage_bin)
    {
        ...
        if ((mb_strlen($warehouse_storage_bin) > 10)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_storage_bin when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationTypeUpdate., must be smaller than or equal to 10.');
        }
