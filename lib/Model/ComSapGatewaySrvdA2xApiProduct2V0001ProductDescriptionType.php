<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductDescription_Type';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['product_description']) && (mb_strlen($this->container['product_description']) > 40)) {
            $invalidProperties[] = "invalid value for 'product_description', the character length must be smaller than or equal to 40.";
        }
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionType., must be smaller than or equal to 18.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionType., must be smaller than or equal to 2.');
        }
    ...
    public function setProductDescription($product_description)
    {
        ...
        if ((mb_strlen($product_description) > 40)) {
            throw new \InvalidArgumentException('invalid length for $product_description when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionType., must be smaller than or equal to 40.');
        }
