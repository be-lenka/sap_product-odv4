...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductSalesDelivery_Type-update';
    ...
    */
    ...
    public function setSupplyingPlant($supplying_plant)
    {
        ...
        if ((mb_strlen($supplying_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplying_plant when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setPriceSpecificationProductGroup($price_specification_product_group)
    {
        ...
        if ((mb_strlen($price_specification_product_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $price_specification_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setAccountDetnProductGroup($account_detn_product_group)
    {
        ...
        if ((mb_strlen($account_detn_product_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $account_detn_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setItemCategoryGroup($item_category_group)
    {
        ...
        if ((mb_strlen($item_category_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $item_category_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setDeliveryQuantityUnit($delivery_quantity_unit)
    {
        ...
        if ((mb_strlen($delivery_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $delivery_quantity_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setDeliveryQuantityIsoUnit($delivery_quantity_iso_unit)
    {
        ...
        if ((mb_strlen($delivery_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $delivery_quantity_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setProductSalesStatus($product_sales_status)
    {
        ...
        if ((mb_strlen($product_sales_status) > 2)) {
            throw new \InvalidArgumentException('invalid length for $product_sales_status when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setSalesMeasureUnit($sales_measure_unit)
    {
        ...
        if ((mb_strlen($sales_measure_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_measure_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setSalesMeasureIsoUnit($sales_measure_iso_unit)
    {
        ...
        if ((mb_strlen($sales_measure_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_measure_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setFirstSalesSpecProductGroup($first_sales_spec_product_group)
    {
        ...
        if ((mb_strlen($first_sales_spec_product_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $first_sales_spec_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setSecondSalesSpecProductGroup($second_sales_spec_product_group)
    {
        ...
        if ((mb_strlen($second_sales_spec_product_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $second_sales_spec_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setThirdSalesSpecProductGroup($third_sales_spec_product_group)
    {
        ...
        if ((mb_strlen($third_sales_spec_product_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $third_sales_spec_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setFourthSalesSpecProductGroup($fourth_sales_spec_product_group)
    {
        ...
        if ((mb_strlen($fourth_sales_spec_product_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $fourth_sales_spec_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setFifthSalesSpecProductGroup($fifth_sales_spec_product_group)
    {
        ...
        if ((mb_strlen($fifth_sales_spec_product_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $fifth_sales_spec_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setLogisticsStatisticsGroup($logistics_statistics_group)
    {
        ...
        if ((mb_strlen($logistics_statistics_group) > 1)) {
            throw new \InvalidArgumentException('invalid length for $logistics_statistics_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setVolumeRebateGroup($volume_rebate_group)
    {
        ...
        if ((mb_strlen($volume_rebate_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $volume_rebate_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setRoundingProfile($rounding_profile)
    {
        ...
        if ((mb_strlen($rounding_profile) > 4)) {
            throw new \InvalidArgumentException('invalid length for $rounding_profile when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setProductCommissionGroup($product_commission_group)
    {
        ...
        if ((mb_strlen($product_commission_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $product_commission_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setPricingReferenceProduct($pricing_reference_product)
    {
        ...
        if ((mb_strlen($pricing_reference_product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $pricing_reference_product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 18.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductSalesDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
