<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProdPlntInternationalTrade_Type-update';
    ...
    */
    ...
    public function setCountryOfOrigin($country_of_origin)
    {
        ...
        if ((mb_strlen($country_of_origin) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country_of_origin when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRegionOfOrigin($region_of_origin)
    {
        ...
        if ((mb_strlen($region_of_origin) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region_of_origin when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setConsumptionTaxCtrlCode($consumption_tax_ctrl_code)
    {
        ...
        if ((mb_strlen($consumption_tax_ctrl_code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $consumption_tax_ctrl_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate., must be smaller than or equal to 16.');
        }
    ...
    public function setExportAndImportProductGroup($export_and_import_product_group)
    {
        ...
        if ((mb_strlen($export_and_import_product_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $export_and_import_product_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setProductCasNumber($product_cas_number)
    {
        ...
        if ((mb_strlen($product_cas_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $product_cas_number when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate., must be smaller than or equal to 15.');
        }
    ...
    public function setProdIntlTradeClassification($prod_intl_trade_classification)
    {
        ...
        if ((mb_strlen($prod_intl_trade_classification) > 9)) {
            throw new \InvalidArgumentException('invalid length for $prod_intl_trade_classification when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdPlntInternationalTradeTypeUpdate., must be smaller than or equal to 9.');
        }
