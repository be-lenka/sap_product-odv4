<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantQualityManagementTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantQualityManagementTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantQualityManagementTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantQualityManagement_Type-update';
    ...
    */
    ...
    public function setProdQltyManagementControlKey($prod_qlty_management_control_key)
    {
        ...
        if ((mb_strlen($prod_qlty_management_control_key) > 8)) {
            throw new \InvalidArgumentException('invalid length for $prod_qlty_management_control_key when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantQualityManagementTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setQualityMgmtSystemForSupplier($quality_mgmt_system_for_supplier)
    {
        ...
        if ((mb_strlen($quality_mgmt_system_for_supplier) > 4)) {
            throw new \InvalidArgumentException('invalid length for $quality_mgmt_system_for_supplier when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantQualityManagementTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setProductQualityCertificateType($product_quality_certificate_type)
    {
        ...
        if ((mb_strlen($product_quality_certificate_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $product_quality_certificate_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantQualityManagementTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setProdQualityAuthorizationGroup($prod_quality_authorization_group)
    {
        ...
        if ((mb_strlen($prod_quality_authorization_group) > 6)) {
            throw new \InvalidArgumentException('invalid length for $prod_quality_authorization_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantQualityManagementTypeUpdate., must be smaller than or equal to 6.');
        }
