<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductValuation_Type-create';
    ...
    protected static $openAPITypes = [
        ...
        '_product_valuation_accounting' => '\BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeCreate',
        '_product_valuation_costing' => '\BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingTypeCreate',
        '_product_valuation_ledger_account' => '\BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationLedgerAccountTypeCreate[]',
        '_product_valuation_ledger_prices' => '\BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationLedgerPricesTypeCreate[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'sap__messages' => null,
        '_product' => null,
        '_product_valuation_accounting' => null,
        '_product_valuation_costing' => null,
        '_product_valuation_ledger_account' => null,
        '_product_valuation_ledger_prices' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'sap__messages' => false,
		'_product' => false,
		'_product_valuation_accounting' => true,
		'_product_valuation_costing' => true,
		'_product_valuation_ledger_account' => false,
		'_product_valuation_ledger_prices' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        '_product' => '_Product',
        '_product_valuation_accounting' => '_ProductValuationAccounting',
        '_product_valuation_costing' => '_ProductValuationCosting',
        '_product_valuation_ledger_account' => '_ProductValuationLedgerAccount',
        '_product_valuation_ledger_prices' => '_ProductValuationLedgerPrices'
    ];
    ...
    protected static $setters = [
        ...
        '_product_valuation_accounting' => '_setProductValuationAccounting',
        '_product_valuation_costing' => '_setProductValuationCosting',
        '_product_valuation_ledger_account' => '_setProductValuationLedgerAccount',
        '_product_valuation_ledger_prices' => '_setProductValuationLedgerPrices'
    ];
    ...
    protected static $getters = [
        ...
        '_product_valuation_accounting' => '_getProductValuationAccounting',
        '_product_valuation_costing' => '_getProductValuationCosting',
        '_product_valuation_ledger_account' => '_getProductValuationLedgerAccount',
        '_product_valuation_ledger_prices' => '_getProductValuationLedgerPrices'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_product_valuation_accounting', $data ?? [], null);
        $this->setIfExists('_product_valuation_costing', $data ?? [], null);
        $this->setIfExists('_product_valuation_ledger_account', $data ?? [], null);
        $this->setIfExists('_product_valuation_ledger_prices', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['valuation_area'] === null) {
            $invalidProperties[] = "'valuation_area' can't be null";
        }
        if ((mb_strlen($this->container['valuation_area']) > 4)) {
            $invalidProperties[] = "invalid value for 'valuation_area', the character length must be smaller than or equal to 4.";
        }

        if ($this->container['valuation_type'] === null) {
            $invalidProperties[] = "'valuation_type' can't be null";
        }
        if ((mb_strlen($this->container['valuation_type']) > 10)) {
     ...
     * Sets valuation_area
     *
     * @param string $valuation_area valuation_area
     *
     * @return self
     */
    public function setValuationArea($valuation_area)
    {
        ...
        if ((mb_strlen($valuation_area) > 4)) {
            throw new \InvalidArgumentException('invalid length for $valuation_area when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 4.');
        }
     ...
     * Sets valuation_type
     *
     * @param string $valuation_type valuation_type
     *
     * @return self
     */
    public function setValuationType($valuation_type)
    {
        ...
        if ((mb_strlen($valuation_type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $valuation_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setValuationClass($valuation_class)
    {
        ...
        if ((mb_strlen($valuation_class) > 4)) {
            throw new \InvalidArgumentException('invalid length for $valuation_class when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setPriceDeterminationControl($price_determination_control)
    {
        ...
        if ((mb_strlen($price_determination_control) > 1)) {
            throw new \InvalidArgumentException('invalid length for $price_determination_control when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setInventoryValuationProcedure($inventory_valuation_procedure)
    {
        ...
        if ((mb_strlen($inventory_valuation_procedure) > 1)) {
            throw new \InvalidArgumentException('invalid length for $inventory_valuation_procedure when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setValuationCategory($valuation_category)
    {
        ...
        if ((mb_strlen($valuation_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $valuation_category when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductUsageType($product_usage_type)
    {
        ...
        if ((mb_strlen($product_usage_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_usage_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductOriginType($product_origin_type)
    {
        ...
        if ((mb_strlen($product_origin_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_origin_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setValuationClassSalesOrderStock($valuation_class_sales_order_stock)
    {
        ...
        if ((mb_strlen($valuation_class_sales_order_stock) > 4)) {
            throw new \InvalidArgumentException('invalid length for $valuation_class_sales_order_stock when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProjectStockValuationClass($project_stock_valuation_class)
    {
        ...
        if ((mb_strlen($project_stock_valuation_class) > 4)) {
            throw new \InvalidArgumentException('invalid length for $project_stock_valuation_class when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    /**
     * Gets _product_valuation_accounting
     *
     * @return \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeCreate|null
     */
    public function _getProductValuationAccounting()
    {
    return $this->container['_product_valuation_accounting'];
    }

    /**
     * Sets _product_valuation_accounting
     *
     * @param \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeCreate|null $_product_valuation_accounting _product_valuation_accounting
     *
     * @return self
     */
    public function _setProductValuationAccounting($_product_valuation_accounting)
    {
        if (is_null($_product_valuation_accounting)) {
            array_push($this->openAPINullablesSetToNull, '_product_valuation_accounting');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('_product_valuation_accounting', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['_product_valuation_accounting'] = $_product_valuation_accounting;

        return $this;
    }

    /**
     * Gets _product_valuation_costing
     *
     * @return \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingTypeCreate|null
     */
    public function _getProductValuationCosting()
    {
    return $this->container['_product_valuation_costing'];
    }

    /**
     * Sets _product_valuation_costing
     *
     * @param \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingTypeCreate|null $_product_valuation_costing _product_valuation_costing
     *
     * @return self
     */
    public function _setProductValuationCosting($_product_valuation_costing)
    {
        if (is_null($_product_valuation_costing)) {
            array_push($this->openAPINullablesSetToNull, '_product_valuation_costing');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('_product_valuation_costing', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['_product_valuation_costing'] = $_product_valuation_costing;

        return $this;
    }

    /**
     * Gets _product_valuation_ledger_account
     *
     * @return \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationLedgerAccountTypeCreate[]|null
     */
    public function _getProductValuationLedgerAccount()
    {
    return $this->container['_product_valuation_ledger_account'];
    }

    /**
     * Sets _product_valuation_ledger_account
     *
     * @param \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationLedgerAccountTypeCreate[]|null $_product_valuation_ledger_account _product_valuation_ledger_account
     *
     * @return self
     */
    public function _setProductValuationLedgerAccount($_product_valuation_ledger_account)
    {
        if (is_null($_product_valuation_ledger_account)) {
            throw new \InvalidArgumentException('non-nullable _product_valuation_ledger_account cannot be null');
        }
        $this->container['_product_valuation_ledger_account'] = $_product_valuation_ledger_account;

        return $this;
    }

    /**
     * Gets _product_valuation_ledger_prices
     *
     * @return \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationLedgerPricesTypeCreate[]|null
     */
    public function _getProductValuationLedgerPrices()
    {
    return $this->container['_product_valuation_ledger_prices'];
    }

    /**
     * Sets _product_valuation_ledger_prices
     *
     * @param \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationLedgerPricesTypeCreate[]|null $_product_valuation_ledger_prices _product_valuation_ledger_prices
     *
     * @return self
     */
    public function _setProductValuationLedgerPrices($_product_valuation_ledger_prices)
    {
        if (is_null($_product_valuation_ledger_prices)) {
            throw new \InvalidArgumentException('non-nullable _product_valuation_ledger_prices cannot be null');
        }
        $this->container['_product_valuation_ledger_prices'] = $_product_valuation_ledger_prices;
