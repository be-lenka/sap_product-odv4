<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProdSalesDeliverySalesTax_Type';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['product_sales_tax_category']) && (mb_strlen($this->container['product_sales_tax_category']) > 4)) {
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType., must be smaller than or equal to 18.');
        }
     ...
     * Sets country
     *
     * @param string|null $country Departure Country/Region (from which the goods are sent)
     *
     * @return self
     */
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType., must be smaller than or equal to 3.');
        }
     ...
     *
     * @param string|null $product_sales_tax_category Tax Condition Type (Sales Tax, Value-Added Tax,...)
     *
     * @return self
     */
    public function setProductSalesTaxCategory($product_sales_tax_category)
    {
        ...
        if ((mb_strlen($product_sales_tax_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $product_sales_tax_category when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType., must be smaller than or equal to 4.');
        }
    ...
    public function setProductSalesOrg($product_sales_org)
    {
        ...
        if ((mb_strlen($product_sales_org) > 4)) {
            throw new \InvalidArgumentException('invalid length for $product_sales_org when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType., must be smaller than or equal to 4.');
        }
    ...
    public function setProductDistributionChnl($product_distribution_chnl)
    {
        ...
        if ((mb_strlen($product_distribution_chnl) > 2)) {
            throw new \InvalidArgumentException('invalid length for $product_distribution_chnl when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType., must be smaller than or equal to 2.');
        }
    ...
    public function setProductTaxClassification($product_tax_classification)
    {
        ...
        if ((mb_strlen($product_tax_classification) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxType., must be smaller than or equal to 1.');
        }
