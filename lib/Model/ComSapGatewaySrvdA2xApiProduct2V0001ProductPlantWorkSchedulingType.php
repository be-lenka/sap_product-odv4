...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantWorkScheduling_Type';
    ...
    */
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 18.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 4.');
        }
    ...
    public function setProductionInvtryManagedLoc($production_invtry_managed_loc)
    {
        ...
        if ((mb_strlen($production_invtry_managed_loc) > 4)) {
            throw new \InvalidArgumentException('invalid length for $production_invtry_managed_loc when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 4.');
        }
    ...
    public function setProductionOrderBatchCode($production_order_batch_code)
    {
        ...
        if ((mb_strlen($production_order_batch_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $production_order_batch_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 1.');
        }
    ...
    public function setTransitionMatrixProductsGroup($transition_matrix_products_group)
    {
        ...
        if ((mb_strlen($transition_matrix_products_group) > 20)) {
            throw new \InvalidArgumentException('invalid length for $transition_matrix_products_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderChangeManagementProfile($order_change_management_profile)
    {
        ...
        if ((mb_strlen($order_change_management_profile) > 6)) {
            throw new \InvalidArgumentException('invalid length for $order_change_management_profile when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 6.');
        }
    ...
    public function setProductComponentBackflushCode($product_component_backflush_code)
    {
        ...
        if ((mb_strlen($product_component_backflush_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_component_backflush_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 1.');
        }
    ...
    public function setProductionSchedulingProfile($production_scheduling_profile)
    {
        ...
        if ((mb_strlen($production_scheduling_profile) > 6)) {
            throw new \InvalidArgumentException('invalid length for $production_scheduling_profile when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 6.');
        }
    ...
    public function setProductionSupervisor($production_supervisor)
    {
        ...
        if ((mb_strlen($production_supervisor) > 3)) {
            throw new \InvalidArgumentException('invalid length for $production_supervisor when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 3.');
        }
    ...
    public function setProductProductionQuantityUnit($product_production_quantity_unit)
    {
        ...
        if ((mb_strlen($product_production_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $product_production_quantity_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 3.');
        }
    ...
    public function setProdProductionQuantityIsoUnit($prod_production_quantity_iso_unit)
    {
        ...
        if ((mb_strlen($prod_production_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prod_production_quantity_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantWorkSchedulingType., must be smaller than or equal to 3.');
        }
