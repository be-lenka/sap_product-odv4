<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductValuationAccounting_Type-update';
    ...
    */
    ...
    public function setDevaluationYearCount($devaluation_year_count)
    {
        ...
        if ((mb_strlen($devaluation_year_count) > 2)) {
            throw new \InvalidArgumentException('invalid length for $devaluation_year_count when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setLifoValuationPoolNumber($lifo_valuation_pool_number)
    {
        ...
        if ((mb_strlen($lifo_valuation_pool_number) > 4)) {
            throw new \InvalidArgumentException('invalid length for $lifo_valuation_pool_number when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationAccountingTypeUpdate., must be smaller than or equal to 3.');
        }
