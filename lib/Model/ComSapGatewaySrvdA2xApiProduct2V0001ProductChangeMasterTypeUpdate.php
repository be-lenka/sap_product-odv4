<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductChangeMaster_Type-update';
    ...
    */
    ...
    public function setRevisionLevel($revision_level)
    {
        ...
        if ((mb_strlen($revision_level) > 2)) {
            throw new \InvalidArgumentException('invalid length for $revision_level when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductChangeMasterTypeUpdate., must be smaller than or equal to 2.');
        }
