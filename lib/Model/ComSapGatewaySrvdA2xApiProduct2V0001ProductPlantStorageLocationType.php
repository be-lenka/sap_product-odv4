<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantStorageLocation_Type';
    ...
    */
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationType., must be smaller than or equal to 18.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationType., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if ((mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationType., must be smaller than or equal to 4.');
        }
    ...
    public function setWarehouseStorageBin($warehouse_storage_bin)
    {
        if (is_null($warehouse_storage_bin)) {
            throw new \InvalidArgumentException('non-nullable warehouse_storage_bin cannot be null');
        }
        if ((mb_strlen($warehouse_storage_bin) > 10)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_storage_bin when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantStorageLocationType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param bool|null $is_marked_for_deletion Flag Material for Deletion at Storage Location Level
     *
     * @return self
     */
