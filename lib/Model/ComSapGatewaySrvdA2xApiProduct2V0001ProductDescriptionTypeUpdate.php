<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductDescription_Type-update';
    ...
    */
    ...
    public function setProductDescription($product_description)
    {
        ...
        if ((mb_strlen($product_description) > 40)) {
            throw new \InvalidArgumentException('invalid length for $product_description when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductDescriptionTypeUpdate., must be smaller than or equal to 40.');
        }
