...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantInspTypSetting_Type-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inspection_lot_type'] === null) {
            $invalidProperties[] = "'inspection_lot_type' can't be null";
        }
        if ((mb_strlen($this->container['inspection_lot_type']) > 8)) {
     ...
     *
     * @param string $inspection_lot_type inspection_lot_type
     *
     * @return self
     */
    public function setInspectionLotType($inspection_lot_type)
    {
        ...
        if ((mb_strlen($inspection_lot_type) > 8)) {
            throw new \InvalidArgumentException('invalid length for $inspection_lot_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate., must be smaller than or equal to 8.');
        }
    ...
    public function setSamplingProcedure($sampling_procedure)
    {
        ...
        if ((mb_strlen($sampling_procedure) > 8)) {
            throw new \InvalidArgumentException('invalid length for $sampling_procedure when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate., must be smaller than or equal to 8.');
        }
    ...
    public function setInspLotDynamicRule($insp_lot_dynamic_rule)
    {
        ...
        if ((mb_strlen($insp_lot_dynamic_rule) > 3)) {
            throw new \InvalidArgumentException('invalid length for $insp_lot_dynamic_rule when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setInspLotSummaryControl($insp_lot_summary_control)
    {
        ...
        if ((mb_strlen($insp_lot_summary_control) > 1)) {
            throw new \InvalidArgumentException('invalid length for $insp_lot_summary_control when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setInspQualityScoreProcedure($insp_quality_score_procedure)
    {
        ...
        if ((mb_strlen($insp_quality_score_procedure) > 2)) {
            throw new \InvalidArgumentException('invalid length for $insp_quality_score_procedure when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setQualityCostCollector($quality_cost_collector)
    {
        ...
        if ((mb_strlen($quality_cost_collector) > 12)) {
            throw new \InvalidArgumentException('invalid length for $quality_cost_collector when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate., must be smaller than or equal to 12.');
        }
    ...
    public function setInspLotOfEwmSummaryControl($insp_lot_of_ewm_summary_control)
    {
        ...
        if ((mb_strlen($insp_lot_of_ewm_summary_control) > 1)) {
            throw new \InvalidArgumentException('invalid length for $insp_lot_of_ewm_summary_control when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantInspTypSettingTypeCreate., must be smaller than or equal to 1.');
        }
