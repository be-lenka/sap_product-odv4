<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantSales_Type-create';
    ...
    */
    ...
    public function setLoadingGroup($loading_group)
    {
        ...
        if ((mb_strlen($loading_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $loading_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setReplacementPartType($replacement_part_type)
    {
        ...
        if ((mb_strlen($replacement_part_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $replacement_part_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setAvailabilityCheckType($availability_check_type)
    {
        ...
        if ((mb_strlen($availability_check_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $availability_check_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantSalesTypeCreate., must be smaller than or equal to 3.');
        }
