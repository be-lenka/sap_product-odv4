...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductStorage_Type-create';
    ...
    */
    ...
    public function setStorageConditions($storage_conditions)
    {
        ...
        if ((mb_strlen($storage_conditions) > 2)) {
            throw new \InvalidArgumentException('invalid length for $storage_conditions when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setProdTemperatureConditionCode($prod_temperature_condition_code)
    {
        ...
        if ((mb_strlen($prod_temperature_condition_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $prod_temperature_condition_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setHazardousProduct($hazardous_product)
    {
        ...
        if ((mb_strlen($hazardous_product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $hazardous_product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 18.');
        }
    ...
    public function setLabelType($label_type)
    {
        ...
        if ((mb_strlen($label_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $label_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setLabelForm($label_form)
    {
        ...
        if ((mb_strlen($label_form) > 2)) {
            throw new \InvalidArgumentException('invalid length for $label_form when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setProductExpirationDateType($product_expiration_date_type)
    {
        ...
        if ((mb_strlen($product_expiration_date_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_expiration_date_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setStorageBinInstruction($storage_bin_instruction)
    {
        ...
        if ((mb_strlen($storage_bin_instruction) > 2)) {
            throw new \InvalidArgumentException('invalid length for $storage_bin_instruction when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setShelfLifeExpirationDatePeriod($shelf_life_expiration_date_period)
    {
        ...
        if ((mb_strlen($shelf_life_expiration_date_period) > 1)) {
            throw new \InvalidArgumentException('invalid length for $shelf_life_expiration_date_period when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setShelfLifeExprtnDateRndngRule($shelf_life_exprtn_date_rndng_rule)
    {
        ...
        if ((mb_strlen($shelf_life_exprtn_date_rndng_rule) > 1)) {
            throw new \InvalidArgumentException('invalid length for $shelf_life_exprtn_date_rndng_rule when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBaseIsoUnit($base_iso_unit)
    {
        ...
        if ((mb_strlen($base_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_iso_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductStorageTypeCreate., must be smaller than or equal to 3.');
        }
