...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProdSalesDeliverySalesTax_Type-update';
    ...
    */
    ...
    public function setProductTaxClassification($product_tax_classification)
    {
        ...
        if ((mb_strlen($product_tax_classification) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification when calling ComSapGatewaySrvdA2xApiProduct2V0001ProdSalesDeliverySalesTaxTypeUpdate., must be smaller than or equal to 1.');
        }
