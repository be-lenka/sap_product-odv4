<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantProcurement_Type-update';
    ...
    */
    ...
    public function setJustInTimeDeliveryScheduleCode($just_in_time_delivery_schedule_code)
    {
        ...
        if ((mb_strlen($just_in_time_delivery_schedule_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $just_in_time_delivery_schedule_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setPurchasingGroup($purchasing_group)
    {
        ...
        if ((mb_strlen($purchasing_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setSourceOfSupplyCategory($source_of_supply_category)
    {
        ...
        if ((mb_strlen($source_of_supply_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $source_of_supply_category when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantProcurementTypeUpdate., must be smaller than or equal to 1.');
        }
