<?php
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantPurchaseTaxTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantPurchaseTaxTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantPurchaseTaxTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductPlantPurchaseTax_Type-create';
    ...
    */
    ...
    public function setDepartureCountry($departure_country)
    {
        ...
        if ((mb_strlen($departure_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $departure_country when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantPurchaseTaxTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setProdPurchaseTaxClassification($prod_purchase_tax_classification)
    {
        ...
        if ((mb_strlen($prod_purchase_tax_classification) > 1)) {
            throw new \InvalidArgumentException('invalid length for $prod_purchase_tax_classification when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductPlantPurchaseTaxTypeCreate., must be smaller than or equal to 1.');
        }
