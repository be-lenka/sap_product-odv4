...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductValuationCosting_Type';
    ...
    */
    ...
    public function setProduct($product)
    {
        ...
        if ((mb_strlen($product) > 18)) {
            throw new \InvalidArgumentException('invalid length for $product when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType., must be smaller than or equal to 18.');
        }
    ...
    public function setValuationArea($valuation_area)
    {
        ...
        if ((mb_strlen($valuation_area) > 4)) {
            throw new \InvalidArgumentException('invalid length for $valuation_area when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType., must be smaller than or equal to 4.');
        }
    ...
    public function setValuationType($valuation_type)
    {
        ...
        if ((mb_strlen($valuation_type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $valuation_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType., must be smaller than or equal to 10.');
        }
    ...
    public function setCostOriginGroup($cost_origin_group)
    {
        ...
        if ((mb_strlen($cost_origin_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cost_origin_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType., must be smaller than or equal to 4.');
        }
    ...
    public function setCostingOverheadGroup($costing_overhead_group)
    {
        ...
        if ((mb_strlen($costing_overhead_group) > 10)) {
            throw new \InvalidArgumentException('invalid length for $costing_overhead_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType., must be smaller than or equal to 10.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductValuationCostingType., must be smaller than or equal to 3.');
        }
