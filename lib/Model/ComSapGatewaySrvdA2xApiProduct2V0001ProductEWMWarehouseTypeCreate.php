...
/**
 * ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\ProductODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_product_2.v0001.ProductEWMWarehouse_Type-create';
    ...
    protected static $openAPITypes = [
        ...
        '_product_ewm_storage_type' => '\BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMStorageTypeTypeCreate[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ewm_warehouse'] === null) {
            $invalidProperties[] = "'ewm_warehouse' can't be null";
        }
        if ((mb_strlen($this->container['ewm_warehouse']) > 4)) {
            $invalidProperties[] = "invalid value for 'ewm_warehouse', the character length must be smaller than or equal to 4.";
        }

        if ($this->container['entitled_to_dispose_party'] === null) {
            $invalidProperties[] = "'entitled_to_dispose_party' can't be null";
        }
        if ((mb_strlen($this->container['entitled_to_dispose_party']) > 10)) {
     ...
     * Sets ewm_warehouse
     *
     * @param string $ewm_warehouse Warehouse Number/Warehouse Complex
     *
     * @return self
     */
    public function setEwmWarehouse($ewm_warehouse)
    {
        ...
        if ((mb_strlen($ewm_warehouse) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_warehouse when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 4.');
        }
     ...
     *
     * @param string $entitled_to_dispose_party Business Partner Number
     *
     * @return self
     */
    public function setEntitledToDisposeParty($entitled_to_dispose_party)
    {
        ...
        if ((mb_strlen($entitled_to_dispose_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $entitled_to_dispose_party when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setBaseUnit($base_unit)
    {
        ...
        if ((mb_strlen($base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $base_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setEwmProductProcessBlockProfile($ewm_product_process_block_profile)
    {
        ...
        if ((mb_strlen($ewm_product_process_block_profile) > 2)) {
            throw new \InvalidArgumentException('invalid length for $ewm_product_process_block_profile when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setEwmProcessTypeControlCode($ewm_process_type_control_code)
    {
        ...
        if ((mb_strlen($ewm_process_type_control_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $ewm_process_type_control_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setEwmStggAreaDeterminationGroup($ewm_stgg_area_determination_group)
    {
        ...
        if ((mb_strlen($ewm_stgg_area_determination_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_stgg_area_determination_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setEwmPtwyControlStrategy($ewm_ptwy_control_strategy)
    {
        ...
        if ((mb_strlen($ewm_ptwy_control_strategy) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_ptwy_control_strategy when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setEwmStorageSectionMethod($ewm_storage_section_method)
    {
        ...
        if ((mb_strlen($ewm_storage_section_method) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_storage_section_method when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setEwmStorageBinType($ewm_storage_bin_type)
    {
        ...
        if ((mb_strlen($ewm_storage_bin_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_storage_bin_type when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setEwmBulkStorageMethod($ewm_bulk_storage_method)
    {
        ...
        if ((mb_strlen($ewm_bulk_storage_method) > 2)) {
            throw new \InvalidArgumentException('invalid length for $ewm_bulk_storage_method when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setEwmStockRemovalControlStrategy($ewm_stock_removal_control_strategy)
    {
        ...
        if ((mb_strlen($ewm_stock_removal_control_strategy) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_stock_removal_control_strategy when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setEwmStockDeterminationGroup($ewm_stock_determination_group)
    {
        ...
        if ((mb_strlen($ewm_stock_determination_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $ewm_stock_determination_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setEwmPhysInventoryCountingCycle($ewm_phys_inventory_counting_cycle)
    {
        ...
        if ((mb_strlen($ewm_phys_inventory_counting_cycle) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ewm_phys_inventory_counting_cycle when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setEwmPreferredUnit($ewm_preferred_unit)
    {
        ...
        if ((mb_strlen($ewm_preferred_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $ewm_preferred_unit when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setEwmPreferredUnitIsoCode($ewm_preferred_unit_iso_code)
    {
        ...
        if ((mb_strlen($ewm_preferred_unit_iso_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $ewm_preferred_unit_iso_code when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setEwmQualityInspectionGroup($ewm_quality_inspection_group)
    {
        ...
        if ((mb_strlen($ewm_quality_inspection_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_quality_inspection_group when calling ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMWarehouseTypeCreate., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMStorageTypeTypeCreate[]|null
     */
     ...
     *
     * @param \BeLenka\SAP\ProductODV4\Model\ComSapGatewaySrvdA2xApiProduct2V0001ProductEWMStorageTypeTypeCreate[]|null $_product_ewm_storage_type _product_ewm_storage_type
     *
     * @return self
     */
